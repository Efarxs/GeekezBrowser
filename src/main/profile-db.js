    ...
    async _migrateFromJson() {
        ...
        try {
            ...
            await this.importBatch(profiles.map(p => ({
                ...
                preProxyStr: p.preProxyStr || '',
                debugPort: p.debugPort || null,
                customArgs: p.customArgs || '',
                resetOnLaunch: !!p.resetOnLaunch,
