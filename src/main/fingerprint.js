...
// Version pool + Sec-CH-UA brand construction live in kernel-versions.js
// so they can be unit-tested from plain Node (this file is a Vite hybrid
// that can't be require()d directly).
const {
