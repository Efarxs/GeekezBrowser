...
window.zhCN = {
    ...
    preProxyModeGlobal: "跟随全局设置",
    preProxyModePool: "强制使用全局代理池",
    preProxyModeDedicated: "使用本环境专属前置",
    preProxyModeOff: "强制关闭（不走前置）",
    preProxyTagPool: "前置：代理池",
    preProxyTagDedicated: "前置：专属",
    preProxyTagOff: "前置：关闭",
    preProxyNoMainHint: "未配置主代理，此前置代理将直接作为出口使用。若只想用一个代理，请填到上面的『代理链接』。",
    preProxyStrLabel: "独立前置代理（仅本环境）",
    preProxyStrHint: "在主代理之前先经过这个上游，例如 socks5://127.0.0.1:7890。填了就覆盖全局前置代理池/模式，且无需打开左上角总开关即可生效。",
    optDefault: "跟随全局",
    optOn: "强制开启",
    optOff: "强制关闭",
    screenRes: "屏幕分辨率",
    ...
    duplicateProfile: "复制环境…",
    dupTitle: "复制环境",
    dupSourceLabel: "源环境",
    dupNameLabel: "新环境名称",
    dupFpLabel: "指纹",
    dupFpKeep: "完全一致（忠实克隆）",
    dupFpKeepHint: "canvas / WebGL / audio 哈希与源一致。同一账号“同一台设备”，防关联最安全。",
    dupFpNew: "换新种子",
    dupFpNewHint: "指纹哈希全新。用于无关联的新身份——此时带登录态会像“同账号换了台设备”。",
    dupWithData: "复制登录态（cookies / localStorage）",
    dupWithDataHint: "需先停止源环境。",
    dupDegradedNote: "该环境开启了每次启动重掷指纹，因此只复制基础配置（不含登录态），等同于普通复制。",
    dupConfirm: "复制",
    dupBusy: "复制中…",
    dupSourceRunning: "复制登录态前请先停止源环境。",
    dupFailed: "复制失败",
    dupDataPartial: "环境已复制，但登录态复制失败：",
    ...
    inlineLaunchErrorViewHint: "点击查看完整错误信息",
    launchErrorTitle: "浏览器启动失败",
    launchErrorLastOutput: "最后输出",
    copyBtn: "复制",
    copied: "已复制",
