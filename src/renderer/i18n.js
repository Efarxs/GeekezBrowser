...
const enTranslations = {
    ...
    platformAutoHint: "Pick a random OS at each launch (or once at creation for a fixed profile). Kernel-level platform spoofing works well but can raise the detection surface slightly.",
